...
Because of the failure of Gumbel-softmax, I start to think a more aggressive perspective, like in binary neural networks where the weight only have to values, can we also say that we let the Boolean variables have either a value of 1 or 0?
